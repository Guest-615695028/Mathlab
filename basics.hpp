...
namespace Mathlab {
	...
	// 5 Iterators
	template <class _T>
	inline constexpr auto begin(_T& t) {
	...
	template <class _T>
	inline constexpr auto end(_T& t) {
	...
	inline constexpr _T* begin(_T(&t)[N]) {
		return t;
	}
	template <class _T, size_t N>
	inline constexpr _T* end(_T(&t)[N]) {
		return t + N;
	}
	template <class _T>
	inline constexpr size_t size(_T& t) {
		return end(t) - begin(t);
	}
	template <class _T>
	inline constexpr bool empty(_T& t) {
		return end(t) == begin(t);
	}
	template <class _T>
	inline constexpr size_t length(_T& t) {
		size_t n = 0;
	...
	inline constexpr void swap(_T& t, _U& u) {
		_T x(u);
		_U y(t);
		t = x;
		u = y;
	...
	inline constexpr void swap(_T(&t)[N], _U(&u)[N]) {
...
#define RealArithmetic typename
	...
	// 8 Type traits
	template <class _T>
	struct Limits : public ::std::numeric_limits<_T> {};
	...
	struct _Signed : _TypeHolder<_T> {};
	template <>
	struct _Signed<char> : _TypeHolder<signed char> {};
	template <>
	struct _Signed<unsigned char> : _TypeHolder<signed char> {};
	template <>
	struct _Signed<char16_t> : _TypeHolder<int16_t> {};
	template <>
	struct _Signed<char32_t> : _TypeHolder<int32_t> {};
	template <>
	struct _Signed<unsigned short> : _TypeHolder<short> {};
	template <>
	struct _Signed<unsigned int> : _TypeHolder<int> {};
	template <>
	struct _Signed<unsigned long> : _TypeHolder<long> {};
	template <>
	struct _Signed<unsigned long long> : _TypeHolder<long long> {};
	template <>
	struct _Signed<wchar_t> : _Signed<wint_t> {};
	template <class _T>
	struct _Signed<const _T> : _Signed<_T> {};
	template <class _T>
	struct _Signed<volatile _T> : _Signed<_T> {};
	template <class _T>
	struct _Signed<const volatile _T> : _Signed<_T> {};
	template <class _T>
	struct _Signed<_T&> : _Signed<_T> {};
	template <class _T>
	struct _Signed<_T&&> : _Signed<_T> {};
	template <class _T>
	using Signed = typename _Signed<_T>::type;

	template <Arithmetic _T>
	struct _Unsigned : _TypeHolder<_T> {};
	template <>
	struct _Unsigned<char> : _TypeHolder<unsigned char> {};
	template <>
	struct _Unsigned<signed char> : _TypeHolder<unsigned char> {};
#if _OLD_CXX
	typedef char char8_t;
#else
	template <>
	struct _Signed<char8_t> : _TypeHolder<int8_t> {};
	template <>
	struct _Unsigned<char8_t> : _TypeHolder<uint8_t> {};
#endif
	template <>
	struct _Unsigned<char16_t> : _TypeHolder<uint16_t> {};
	template <>
	struct _Unsigned<char32_t> : _TypeHolder<uint32_t> {};
	template <>
	struct _Unsigned<short> : _TypeHolder<unsigned short> {};
	template <>
	struct _Unsigned<int> : _TypeHolder<unsigned int> {};
	template <>
	struct _Unsigned<long> : _TypeHolder<unsigned long> {};
	template <>
	struct _Unsigned<long long> : _TypeHolder<unsigned long long> {};
	template <>
	struct _Unsigned<wchar_t> : _Unsigned<wint_t> {};
	template <class _T>
	struct _Unsigned<const _T> : _Unsigned<_T> {};
	template <class _T>
	struct _Unsigned<volatile _T> : _Unsigned<_T> {};
	template <class _T>
	struct _Unsigned<const volatile _T> : _Unsigned<_T> {};
	template <class _T>
	struct _Unsigned<_T&> : _Unsigned<_T> {};
	template <class _T>
	struct _Unsigned<_T&&> : _Unsigned<_T> {};
	template <class _T>
	using Unsigned = typename _Unsigned<_T>::type;

	template <Arithmetic _T>
	struct _Promoted : _TypeHolder<double> {};
	template <>
	struct _Promoted<float> : _TypeHolder<float> {};
	template <>
...
#define _MIN_MAX_REQ requires (LessThanComparable<_T, _U> && ...)
	...
	template <FloatingPoint _T = float>
	inline constexpr _T nan(bool b = 0) noexcept {
